/*
------------------------------------------------------------------------
sJavaANPR - Automatic Number Plate Recognition System for Java
------------------------------------------------------------------------
...
import anpr.Core;
import anpr.Main;
import gui.tools.FileListModel;
import gui.tools.ImageFileFilter;
import anpr.*;
...
//				this.parentFrame.panelCarContent = ImageIO.read(new File(this.url));
    ...
    private void initComponents() {
        ...
        bottomLine.setText(" [ <GUI from 2006 Ondrej Martinsky> Modified by (2023-2024) Oh and Hazim ]. \t "
        		+ "\t [ Algorithm Copyright (c) 2023-2024 ]");
