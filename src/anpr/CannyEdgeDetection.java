...
public class CannyEdgeDetection implements PlugIn {
	...
	private static float sGaussianKernelRadius =2.8f;
	private static float sLowThreshold = 5.0f;
	private static float sHighThreshold = 10f;

	private float gaussianKernelRadius = 2.8f;
	private float lowThreshold = 5.0f;
	private float highThreshold = 10f;
